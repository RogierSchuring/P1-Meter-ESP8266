...
const char* ssid = "YOURWIFIACCESSPOINTSSID";
const char* password = "YOURWIFIACCESSPOINTPASSWORD";
const char* hostName = "ESPP1Meter";
const char* domoticzIP = "192.168.1.10";
const int domoticzPort = 80;
const int domoticzGasIdx = 10;
const int domoticzEneryIdx = 11;
...
int resetCounter = 0; //counter
#define MAXLOGLINES 40
struct LogStruct
{
...
void setup() {
  ...
  ArduinoOTA.onError([](ota_error_t error) {
    Serial.printf("Error [%u] during OTA upload: ", error);
